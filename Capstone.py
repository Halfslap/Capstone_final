...
st.text("Pandas version: ", pd.__version__)


# In[5]:


st.text("Numpy version: ", np.__version__)


# In[6]:


st.text("Streamlit version: ", st.__version__)


# In[7]:


st.text("Matplotlib version: ", matplotlib.__version__)
